...
const Login = () => {
  ...
  return (
    ...
    <h2 style={{ position: "relative", bottom: "300px", right: "300px", transform: "scaleX(-1.5)",}} > <Link to="/" className='text-gray-500 hover:text-gray-900'><FaSignOutAlt/></Link></h2>
      ...
      <div>
        <img src='https://www.shutterstock.com/image-vector/girl-listening-music-on-headphones-600nw-2420570351.jpg' width='200px' style={{marginRight:"35px",height:"360px"}} />
      </div>
